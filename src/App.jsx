...
function App() {
  ...
  useEffect(() => {
    // Check if user already saw the cover this session
    if (sessionStorage.getItem('chatpati-cover-seen') === 'true') {
    ...
    <Layout>
      ...
      */}
      <div id="home-page-wrapper" style={hasSeenCover ? { opacity: 1, transform: 'translateY(0)' } : undefined}>
        ...
        <div ref={containerRef} className="relative h-[1000vh] bg-[#0a0908] z-10">
          <MenuManuscript />
