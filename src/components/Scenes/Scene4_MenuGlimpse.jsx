    ...
    <div className="absolute inset-0 w-full h-full pointer-events-none z-30">
      ...
      <motion.div className="absolute inset-0 flex items-center justify-center bg-surface-base" style={{ opacity: bOpacity, scale: bScale }}>
        ...
        <div className="hidden lg:block absolute right-0 w-[70%] h-[120%] rotate-[-5deg] overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-l from-transparent to-surface-base z-10" />
        </div>
      ...
      <motion.div className="absolute inset-0 flex items-center justify-center bg-[#0a0503]" style={{ opacity: dOpacity, scale: dScale }}>
        ...
        >
          <h2 className="font-serif text-[13rem] text-content-primary leading-[0.75] tracking-tighter opacity-80 mix-blend-overlay">
            The Feast
          </h2>
        </motion.div>
