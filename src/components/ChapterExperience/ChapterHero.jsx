  ...
  return (
    <section className={`relative min-h-[45vh] flex items-end bg-gradient-to-b ${accent} to-[#0a0908] overflow-hidden`}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pb-16 pt-32 w-full">
        <span className="font-sans text-[10px] tracking-[0.4em] uppercase text-primary-gold/70 block mb-5">
          Menu Chapter
        </span>
        <h1 className="font-serif text-5xl md:text-7xl lg:text-8xl text-primary-cream mb-6 leading-none">
          {title}
        </h1>
        {description && (
          <p className="font-sans text-sm md:text-base text-primary-cream/55 max-w-xl leading-relaxed">
            {description}
          </p>
        )}
      </div>
