  ...
  return (
    <section className="h-[80vh] bg-surface-card relative flex items-center justify-center overflow-hidden border-t border-border-subtle">
      ...
      <div className="relative z-10 text-center px-4">
        <span className="font-sans text-[10px] tracking-[0.4em] uppercase text-accent-gold/70 block mb-8">
          Begin Your Journey
        </span>

        <h2 className="font-serif text-5xl md:text-7xl lg:text-8xl text-content-primary mb-12 leading-none">
          Let's Create An <br />
          <span className="italic text-accent-gold font-light">Unforgettable Celebration</span>
        </h2>

        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          <Link
            to="/contact"
            className="px-8 py-4 font-sans text-xs tracking-widest uppercase transition-transform duration-300 hover:-translate-y-1 flex items-center justify-center min-w-[200px] bg-accent-gold text-surface-base hover:bg-content-primary hover:text-surface-base hover:shadow-lg hover:shadow-accent-gold/20"
          >
            Book Catering
          </Link>
          <Link
