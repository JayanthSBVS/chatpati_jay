  ...
  return (
    <section ref={containerRef} className="relative h-screen w-full flex flex-col justify-center items-center overflow-hidden bg-[#050403]">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto animate-fade-in" style={{ animationDelay: '0.2s' }}>
        <p className="font-sans text-xs md:text-sm tracking-[0.4em] uppercase text-primary-gold mb-8 animate-fade-in" style={{ animationDelay: '0.2s' }}>
          A Legacy of Flavor
        </p>
        
        <h1 className="font-serif text-5xl md:text-7xl lg:text-8xl text-primary-cream leading-[1.1] mb-6 animate-fade-in" style={{ animationDelay: '0.4s' }}>
          Where Every Event <br />
          <span className="italic font-light text-primary-gold">Becomes a</span> <br />
          Culinary Celebration
        </h1>

        <p className="font-sans text-sm md:text-base text-primary-cream/60 max-w-xl mx-auto font-light leading-relaxed animate-fade-in" style={{ animationDelay: '0.6s' }}>
      ...
      <div className="absolute bottom-12 left-1/2 -translate-x-1/2 hidden md:flex flex-col items-center gap-4 animate-fade-in" style={{ animationDelay: '1.5s' }}>
        ...
        <div className="w-[1px] h-16 bg-gradient-to-b from-primary-gold/50 to-transparent overflow-hidden">
          <div 
            ...
            className="w-full h-full bg-primary-gold origin-top"
          />
        </div>
      </div>
      ...
      <div className="absolute bottom-12 left-0 right-0 px-6 md:hidden flex justify-center animate-fade-in" style={{ animationDelay: '1s' }}>
        <a 
          ...
          onClick={exploreMenu}
          className="w-full max-w-[300px] min-h-[56px] flex items-center justify-center bg-[#CBAA6A]/10 border border-[#CBAA6A]/30 text-[#CBAA6A] font-sans text-sm tracking-widest uppercase rounded-sm hover:bg-[#CBAA6A]/20 active:scale-[0.98] active:opacity-80 transition-all duration-100"
        >
          ↓ Explore Menu
        </a>
      </div>
